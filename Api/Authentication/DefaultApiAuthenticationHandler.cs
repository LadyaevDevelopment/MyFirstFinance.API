...
namespace Api.Authentication
{
	public class DefaultApiAuthenticationHandler(
		...
		IUserRepository userRepository) : AuthenticationHandler<DefaultApiAuthenticationOptions>(options, logger, encoder, clock)
	{
		...
		protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
		{
			...
			var userModel = await new TokenProcessor(userRepository).UserByToken(token);
